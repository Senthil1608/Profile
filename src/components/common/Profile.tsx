...
function Profile() {
  return (
    <div className="container my-5">
      <div className="card shadow-lg p-4 border-0 rounded-4 text-center" style={{background : "#aac5ffff"}}>
        <div className="row justify-content-center">
          ...
          <div className="col-md-8 d-flex flex-column justify-content-center">
            ...
            <h5 className="text-black mb-3">React Developer @ HCL Technologies Ltd</h5>
